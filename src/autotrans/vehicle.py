...
class Vehicle:
    ...
    def __init__(
        ...
        # State variables
        initial_wheel_speed = initial_speed / wheel_radius
        self._wheel_speed = initial_wheel_speed
        self._transmission_rpm = initial_wheel_speed * final_drive_ratio
        self._speed = _into_mph(initial_wheel_speed)
